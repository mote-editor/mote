...
class Buffer:
    ...
    def __init__(self, text="", screen_height=24, screen_width=80, name="Untitled"):
        # Store text as lots of lines, preserving a trailing final newline and handling CRLF
